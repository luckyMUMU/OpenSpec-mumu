...
| 文档类型 | 当前版本 | 上次更新 | 更新原因 |
|----------|----------|----------|----------|
| AGENT_SOP.md | v1.4.0 | 2026-02-09 | L2架构文档Markdown化 |
| ROLE_CHEATSHEET.md | v1.4.0 | 2026-02-09 | 版本号修正 |
| 02_role_matrix/index.md | v1.4.0 | 2026-02-09 | 添加停止点列 |
| 03_workflow/index.md | v1.4.0 | 2026-02-09 | 补充测试与监管停止点 |
| Skill文件 | v1.4.0 | 2026-02-09 | 版本一致性对齐 |
| design_decision_rules.md | v1.4.0 | 2026-02-10 | 新增design.md创建判断规则 |
...
| **角色文档** | 02_role_matrix/index.md | 11个角色定义完整 |
| **工作流文档** | 03_workflow/*.md | 快速/深度/TDD路径完整 |
| **约束文档** | 05_constraints/*.md | 禁止项/验收标准完整 |
| **角色指令** | prompts/*.md | 11个角色指令完整 |

#### 流程完整性检查清单

- [ ] 快速路径完整（Explorer → Worker → Librarian）
- [ ] 深度路径完整（包含分层验收）
- [ ] 所有停止点定义
- [ ] 三错规则定义
- [ ] 文档同步规则
